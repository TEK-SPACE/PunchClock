...
namespace PunchClock.Core.DataAccess.Seeders
{
    public partial class PunchDbInitializer
    {
        private void SeedProjects(PunchClockDbContext context)
        {
            ...
            {
                new TicketProject {Id = 1, Name = "Human Resources", Description = "", DisplayOrder = 1,CompanyId =context.Companies.First().Id},
                new TicketProject {Id = 2, Name = "Marketing", Description = "", DisplayOrder = 1,CompanyId =context.Companies.First().Id},
